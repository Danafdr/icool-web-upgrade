...
export default function AboutSection() {
    return (
        <section className="py-20 lg:py-32 relative overflow-hidden" id="about">
            ...
            <div className="absolute top-1/4 -right-32 w-96 h-96 bg-brand-green/10 blur-[100px] rounded-full z-0 pointer-events-none"></div>
            ...
            <div className="container mx-auto px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <div className="space-y-8 md:space-y-10 order-2 lg:order-1">
                        ...
                        {/* CTA */}
                        <div className="pt-8">
                            <Button asChild variant="outline" className="border-brand-green/50 text-brand-green hover:bg-brand-green hover:text-black rounded-full px-8 py-6 text-lg transition-all shadow-[0_0_20px_rgba(34,197,94,0.1)] hover:shadow-[0_0_30px_rgba(34,197,94,0.3)]">
                    ...
                    <div className="relative order-1 lg:order-2">
                        <div className="aspect-[4/5] sm:aspect-square lg:aspect-[4/5] rounded-3xl overflow-hidden relative group border border-white/10">
                            ...
                            <img 
                                ...
                                className="w-full h-full object-cover scale-105 group-hover:scale-100 transition-transform duration-700 grayscale-[20%] group-hover:grayscale-0"
                            />
                        </div>
                        {/* Floating Badge */}
